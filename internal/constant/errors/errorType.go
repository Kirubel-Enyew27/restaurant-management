...
var Error = []ErrorType{
	...
	},
	{
		...
		StatusCode: http.StatusInternalServerError,
		ErrorType:  ErrRedisWriteError,
	}, {
		StatusCode: http.StatusInternalServerError,
		ErrorType:  ErrRedisReadError,
	}, {
		StatusCode: http.StatusInternalServerError,
		ErrorType:  ErrSendNotificationFailed,
	}, {
		StatusCode: http.StatusInternalServerError,
		ErrorType:  ErrRedisUnableToPublish,
	}, {
		StatusCode: http.StatusInternalServerError,
		ErrorType:  ErrRedisPubSubUnableToGetRoute,
	}, {
		StatusCode: http.StatusInternalServerError,
		ErrorType:  ErrRedisPubSubBadEvent,
	},
	{
		StatusCode: http.StatusInternalServerError,
		ErrorType:  ErrClusteringFailed,
	},
	{
		StatusCode: http.StatusInternalServerError,
		...
		StatusCode: http.StatusInternalServerError,
		ErrorType:  ErrCreateCheckoutSession,
	},
	{
		StatusCode: http.StatusInternalServerError,
...
var (
	...
	badRequest              = errorx.NewNamespace("bad request error").ApplyModifiers(errorx.TypeModifierOmitStackTrace)
	...
	redisDBError        = errorx.NewNamespace("redis db error")
	clusteringAPIError  = errorx.NewNamespace("clustering error")
	packagingError      = errorx.NewNamespace("packaging error")
	paymentgatewayError = errorx.NewNamespace("paymentGateway error")
)
...
var (
	...
	ErrRedisWriteError             = errorx.NewType(redisDBError, "unable to write to redis ")
	ErrRedisReadError              = errorx.NewType(redisDBError, "unable to read from redis ")
	ErrSendNotificationFailed      = errorx.NewType(httpError, "unable to  send http request")
	ErrClusteringFailed            = errorx.NewType(clusteringAPIError, "failed to make clustering")
	ErrRedisUnableToPublish        = errorx.NewType(redisDBError, "publish to redis server ")
	ErrRedisPubSubUnableToGetRoute = errorx.NewType(redisDBError, "unable to get route ")
	ErrRedisPubSubBadEvent         = errorx.NewType(redisDBError, "unable to unmarshal event ")
	UnexpectedError                = errorx.NewType(serverError, "invalid value")
	ErrAlreadyPackaged             = errorx.NewType(packagingError, "order already packaged").
					ApplyModifiers(errorx.TypeModifierOmitStackTrace)
